        ...
        <div className="flex gap-3 overflow-x-auto pb-4 custom-scrollbar snap-x snap-mandatory items-center">
          ...
          <div className="shrink-0 snap-center relative">
            <button
              ...
              className={`relative shrink-0 w-16 h-16 rounded-full flex flex-col items-center justify-center transition-all duration-300 ease-out border-2 border-dashed ${
                isCustomUrl 
                  ? "border-indigo-500 bg-[var(--surface)] ring-4 ring-indigo-500/30 scale-110 shadow-xl" 
            ...
            >
              {isUploading ? (
                ...
                <Avatar url={value} size="xl" className="absolute inset-0 w-full h-full rounded-full" />
              ) : (
                <>
